...
__decorate([
    (0, typeorm_1.ManyToOne)(() => user_entity_1.User, (user) => user.resources),
...
], Resource.prototype, "resource_url", void 0);
__decorate([
    (0, typeorm_1.Column)({ type: 'datetime' }),
    __metadata("design:type", Date)
], Resource.prototype, "expiration_time", void 0);
__decorate([
    (0, typeorm_1.Column)({
        type: 'enum',
        enum: ['active', 'expired'],
...
exports.Resource = Resource = __decorate([
    (0, typeorm_1.Entity)('fileStore'),
    (0, typeorm_1.Index)('IDX_USER_STATUS', ['user', 'status']),
    (0, typeorm_1.Index)('IDX_EXPIRATION_TIME', ['expiration_time'])
], Resource);
